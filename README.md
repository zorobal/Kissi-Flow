...
*   **📦 Gestion Logistique (Stocks & Inventaires)** : Fiches ingrédients avec gestion d'alertes par seuil critique, enregistrement des pertes de cuisine motivées, et fiches d'inventaires physiques pour le calcul automatique de la démarque inconnue.
...
*   **📊 Bilan Analytique & Soldes Intermédiaires de Gestion (SIG)** : Calcul automatisé du compte de résultat d'exploitation complet (Consolidation Produits vs Charges, Food Cost, Résultat Net comparatif BOM/Resto).
